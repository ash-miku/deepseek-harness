...
- `@deepseek-ai/dsh-client-ui-git-changes` — 需要 `connection` · `sessionController` · `sandboxPolicy`（[`packages/client/ui-git-changes/src/index.ts`](../packages/client/ui-git-changes/src/index.ts)）
