...
export interface IWorkspaces {
  ...
  /**
   * Archive a Session from Workspace grouping surfaces. The Session log and
   * its Workspace accounting slot remain; only grouping visibility changes.
  ...
  /**
   * Favorite (pin) a Session: it moves to the top of every grouping surface.
   * The Session log and Workspace accounting slot remain untouched.
