...
type WorkspaceFollowFrame =
  ...
  | { readonly type: 'favorite'; readonly favoriteSessionIds: readonly SessionId[] }
  ...
  const workspaceApi: FixtureWorkspaceApi = {
    ...
    favoriteSession: (request) => {
      ...
      if (!favoriteSessionIds.includes(request.sessionId)) {
        ...
        emitWorkspace({ type: 'favorite', favoriteSessionIds: [...favoriteSessionIds] })
      }
  ...
  const rpc: ClientConnectionRpc = {
    call(channel, endpoint, payload, signal) {
      ...
      switch (endpoint) {
        ...
        case 'workspace/favoriteSession': return workspaceApi.favoriteSession(request as WorkspaceFavoriteSessionRequest)
        case 'workspace/unfavoriteSession': return workspaceApi.unfavoriteSession(request as WorkspaceUnfavoriteSessionRequest)
        default:
