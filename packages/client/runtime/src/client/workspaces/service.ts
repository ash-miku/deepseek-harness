...
export class WorkspaceRuntime implements IWorkspaces {
  ...
  /**
   * Restore a session from the registry-global archive set. The session log
   * and accounting slot remain untouched.
  ...
  /** Stop a pending Workspace baseline retry when the connection generation dies. */
