...
export const zh = {
  ...
  'settings.display.title': '过程内容展示',
  'settings.display.description': '控制思考摘要和工具调用在对话中的展示方式；折叠时统一收纳过程，正式回答展示在下方',
  'settings.display.full': '完整过程',
  'settings.display.fold': '折叠过程',
  'settings.display.conclusion': '仅结论',
  'process.title': '过程',
  'process.toolTitle': '工具调用',
  'process.toolCount': '{count} 次调用',
  'process.thinkingCount': '{count} 段思考',
  'process.collapse': '点击收起',
  'settings.runningLabel.title': '运行中提示文案',
  'settings.runningLabel.description': '每行填一条，运行时随机轮换；留空恢复默认',
  'settings.runningLabel.placeholder': 'Deep diving...\nThinking hard...\nWorking...',
  'settings.completionSound.title': '任务完成提示音',
  'settings.completionSound.description': '选择任务结束时播放的提示音',
  'settings.completionSound.off': '关闭',
  'settings.completionSound.dingDong': '叮咚',
  'settings.completionSound.bell': '铛',
  'settings.completionSound.chime': '清脆铃声',
  'settings.completionSound.preview': '试听',
  'settings.completionSound.volume.title': '提示音音量',
  'settings.completionSound.volume.description': '仅影响应用内提示音，系统音量仍然有效',
  'settings.completionSound.volume.value': '{value}%',
...
export const en = {
  ...
  'settings.display.title': 'Process display',
  'settings.display.description': 'Choose how thinking summaries and tool calls appear; fold mode groups them in one disclosure below the final answer',
  'settings.display.full': 'Full process',
  'settings.display.fold': 'Fold process',
  'settings.display.conclusion': 'Conclusion only',
  'process.title': 'Process',
  'process.toolTitle': 'Tool calls',
  'process.toolCount': '{count} calls',
  'process.thinkingCount': '{count} thinking blocks',
  'process.collapse': 'Click to collapse',
  'settings.runningLabel.title': 'Running label',
  'settings.runningLabel.description': 'Add one label per line; the chat picks one randomly while the agent runs. Leave blank to restore the default.',
  'settings.runningLabel.placeholder': 'Deep diving...\nThinking hard...\nWorking...',
  'settings.completionSound.title': 'Completion sound',
  'settings.completionSound.description': 'Choose the sound played after a task completes',
  'settings.completionSound.off': 'Off',
  'settings.completionSound.dingDong': 'Ding-dong',
  'settings.completionSound.bell': 'Bell',
  'settings.completionSound.chime': 'Bright chime',
  'settings.completionSound.preview': 'Preview',
  'settings.completionSound.volume.title': 'Completion sound volume',
  'settings.completionSound.volume.description': 'Controls the app sound; system volume still applies',
  'settings.completionSound.volume.value': '{value}%',
