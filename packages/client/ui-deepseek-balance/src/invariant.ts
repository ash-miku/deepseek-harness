 ...
 * controller, both released by the same effect disposer. The lifecycle spec
 * proves the registration is withdrawn and the controller is dropped when the
 * owning fiber is disposed, so no second authority exists to check at runtime.
 */
