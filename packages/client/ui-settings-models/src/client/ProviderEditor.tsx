 ...
 * same reason).
 * Reasoning effort stays per-MODEL: the model list below declares each row's
 * own `reasoningEfforts` (offered levels and their wire spellings), and the
 * composer's model picker offers those levels. Everything else stays owned by
