...
export const en = {
  ...
  reasoningInherit: 'Use provider default',
  reasoningOff: 'No reasoning',
  reasoningOn: 'Declare thinking levels',
  reasoningLevel: 'Thinking level',
  reasoningWire: 'Wire value',
  reasoningWireHint: 'How this level is named in the request',
  reasoningOffWireHint: 'Empty sends nothing',
  modelReasoningInvalid: 'Thinking levels must offer at least one level beyond Off, and every other level needs a wire value.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  reasoningEfforts: '思考等级',
  reasoningInherit: '使用提供方默认',
  reasoningOff: '不支持推理',
  reasoningOn: '声明思考等级',
  reasoningLevel: '思考档位',
  reasoningWire: '发送值',
  reasoningWireHint: '该档位在请求中发送的拼写',
  reasoningOffWireHint: '留空表示支持且不发送值',
  modelReasoningInvalid: '思考等级至少需要一个 Off 以外的档位，且每个非 Off 档位都必须填写发送值。',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供方\u2026',
