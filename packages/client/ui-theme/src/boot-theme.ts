...
function bootThemeBodyScript(preference: ThemePreference, fontSize: number, fontWeight: ThemeFontWeight): string {
  return `(() => {
...
export function bootThemeInjections(
  ...
  return [
    ...
    { kind: 'script', placement: 'body', text: bootThemeBodyScript(preference, fontSize, fontWeight) },
  ]
}
