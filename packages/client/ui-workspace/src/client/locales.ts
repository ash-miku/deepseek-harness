...
export const zh = {
  ...
  'archiveInactive.action': '归档未更新会话',
  'archiveInactive.title': '归档未更新会话',
  'archiveInactive.field': '归档时间',
  'archiveInactive.days': '{n} 天',
  'archiveInactive.summary': '将归档 {n} 个空闲会话；当前、运行中、待交互、空白、子代理和已归档会话会保留。',
  'archiveInactive.empty': '没有符合条件的会话。',
  'archiveInactive.pending': '正在归档 {n} 个会话…',
  'archiveInactive.done': '已归档 {n} 个会话。',
  'archiveInactive.partial': '已归档 {archived} 个会话，{failed} 个失败。',
  'archiveInactive.failures': '{failed} 个会话归档失败，日志已保留。',
  'archiveInactive.confirm': '归档',
...
export const en = {
  ...
  'archiveInactive.action': 'Archive inactive sessions',
  'archiveInactive.title': 'Archive inactive sessions',
  'archiveInactive.field': 'Inactivity threshold',
  'archiveInactive.days': '{n} days',
  'archiveInactive.summary': 'Will archive {n} idle sessions. Current, running, pending, blank, subagent, and already-archived sessions stay visible.',
  'archiveInactive.empty': 'No sessions match this threshold.',
  'archiveInactive.pending': 'Archiving {n} sessions…',
  'archiveInactive.done': 'Archived {n} sessions.',
  'archiveInactive.partial': 'Archived {archived} sessions and {failed} failed.',
  'archiveInactive.failures': '{failed} sessions could not be archived. Their logs stay intact.',
  'archiveInactive.confirm': 'Archive',
