...
import {
  ...
  IconLikeFill16, IconLikeOutline16, IconPlusOutline16, IconTrashOutline16,
...
export function ProjectRowItem({ group, containsCurrentDescendant = false, onToggle, onCreate, actions, drag, home, t }: {
  ...
  const row = group
  // Ungrouped, favorite, and archived buckets have no workspace title:
  // dictionary copy.
 ...
 * @param props.onFavorite - favorite (pin) a session by id.
 * @param props.onUnfavorite - unfavorite (unpin) a session by id.
...
export function SessionNodeItem({
  ...
  onFavorite, onUnfavorite, onReveal, drag, flat = false, t,
}: {
  node: SessionNode
  currentId: string | undefined
  now: number
