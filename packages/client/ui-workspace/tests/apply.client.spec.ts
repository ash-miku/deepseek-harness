...
async function bench() {
  ...
  return {
    ...
    insertSessionBefore, open, clear, selectPanel, search, renameSession, binding, fork,
    pickDirectory, collapseSidebar,
  }
}
...
describe('ui-workspace apply', () => {
  ...
  it('routes browser actions and picker creation to the services', async () => {
    ...
    // Both arms delegate to the shared Session navigation action and dismiss
    // the mobile drawer (no-op while wide).
