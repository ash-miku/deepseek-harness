...
async function createRuntime(): Promise<SlotTestRuntime> {
  ...
  // The injected open/startSession arms dismiss the mobile drawer and the
  // navigation controller clears the active panel and aborts on re-entry, so
  // the bench stands in for every member of the layout service face this
  // package injects.
