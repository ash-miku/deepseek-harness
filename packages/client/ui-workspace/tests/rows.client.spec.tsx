...
describe('workspace browser rows', () => {
  ...
  it('renders and opens a selected running Session row', () => {
    ...
    render(
      <SessionNodeItem node={node} currentId={node.id} now={0} onOpen={onOpen}
        onRename={vi.fn()} onFork={vi.fn()} onArchive={vi.fn()} onUnarchive={vi.fn()} onFavorite={vi.fn()} onUnfavorite={vi.fn()} t={t} />,
    )
  ...
  it('reveals a clipped session title by scrolling it while the row is hovered', () => {
    ...
    render(
      <SessionNodeItem node={node} currentId={undefined} now={0} onOpen={vi.fn()}
        onRename={vi.fn()} onFork={vi.fn()} onArchive={vi.fn()} onUnarchive={vi.fn()}
        onFavorite={vi.fn()} onUnfavorite={vi.fn()} t={t} />,
    )
    const row = screen.getByRole('treeitem')
  ...
  it('keeps the active-Schedule marker between the title and time in grouped and flat rows', () => {
    ...
    const view = render(
      <SessionNodeItem node={node} currentId={undefined} now={0} onOpen={onOpen}
        ...
        onUnarchive={vi.fn()} onFavorite={vi.fn()} onUnfavorite={vi.fn()} t={t} />,
    )
    ...
    view.rerender(
      <SessionNodeItem node={node} currentId={undefined} now={0} onOpen={onOpen}
        onRename={vi.fn()} onFork={vi.fn()} onArchive={vi.fn()}
        onUnarchive={vi.fn()} onFavorite={vi.fn()} onUnfavorite={vi.fn()} flat t={t} />,
    )
    assertIndicator()
  })
  ...
  it('session row menu opens without opening the session and dispatches rename, fork, and archive', () => {
    ...
    render(<SessionNodeItem node={node} currentId={undefined} now={0} onOpen={onOpen}
      onRename={onRename} onFork={onFork} onArchive={onArchive} onUnarchive={vi.fn()} onFavorite={vi.fn()} onUnfavorite={vi.fn()} t={t} />)
