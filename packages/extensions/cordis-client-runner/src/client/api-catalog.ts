  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Restore a session from the registry-global archive set; the session returns to its normal grouping while its log and accounting slot remain.',
