...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'archiveSession(sessionId: SessionId): Promise<void>',
        description: 'Archive a Session from Workspace grouping surfaces. The Session log and its Workspace accounting slot remain; only grouping visibility changes.',
        parameters: [{ name: 'sessionId', description: 'Session to archive.' }],
      },
      {
      ...
      },
      {
        ...
        description: 'Favorite (pin) a Session: it moves to the top of every grouping surface. The Session log and Workspace accounting slot remain untouched.',
        parameters: [{ name: 'sessionId', description: 'Session to favorite.' }],
      },
      {
        signature: 'unfavoriteSession(sessionId: SessionId): Promise<void>',
        description: 'Unfavorite (unpin) a Session from the registry-global favorite set.',
        parameters: [{ name: 'sessionId', description: 'Session to unfavorite.' }],
      },
      {
