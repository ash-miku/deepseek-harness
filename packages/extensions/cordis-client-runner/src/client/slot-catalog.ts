...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      'client-ui-conversation ComposerDock id \'content\'',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'conversation.composer.dock.content',
    kind: 'list',
    scope: 'session',
    summary: 'Dock content with the current session\'s tab-selection action.',
    doc: 'Dock content with the current session\'s tab-selection action.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'conversation.composer.dock\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-chat StatsPills id \'stats\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.composer.dock.content\', () => ctx.slots.register(\n      { name: \'conversation.composer.dock.content\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:172',
  },
  {
    key: 'conversation.composer.dock.stats',
    kind: 'list',
    scope: 'session',
    summary: 'Additional workspace statistics beside the session usage pills.',
    doc: 'Additional workspace statistics beside the session usage pills.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'conversation.composer.dock.content\' (client-ui-chat), so it exists while that entry is mounted',
    occupants: [
      'client-ui-git-changes GitChangesStats id \'git-changes\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.composer.dock.stats\', () => ctx.slots.register(\n      { name: \'conversation.composer.dock.stats\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-git-changes GitChangesView id \'changes\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-conversation CompletionSoundRow id \'conversation-completion-sound\'',
      'client-ui-conversation CompletionSoundVolumeRow id \'conversation-completion-sound-volume\'',
      ...
      'client-ui-theme FontWeightRow id \'font-weight\'',
    ],
    replaceRisk: 'none',
