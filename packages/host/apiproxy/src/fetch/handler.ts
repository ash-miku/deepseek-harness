...
import { deepseekBalanceRequestSchema } from '../api/deepseek.schema.ts'
import {
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'deepseek.balance': { schema: deepseekBalanceRequestSchema, invoke: (api, r) => api.deepseek.balance(r) },
}
