...
| `@deepseek-ai/dsh-client-ui-git-changes` | no | Workspace Git changes Conversation View: status list plus inline/side-by-side diff over an authenticated Host route |
