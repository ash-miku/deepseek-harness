...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  chatRunningLabels: 'client-side optional running-label provider (ChatRunningLabelsSource) — packages/client/ui-chat/README.md owns the API',
...
export const EVENT_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  'session/completed': 'client-face completion notification — packages/api/session-controller/README.md owns the API',
